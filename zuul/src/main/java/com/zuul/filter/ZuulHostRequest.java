...
class ZuulHostRequest extends ZuulFilter {
    ...
    private InputStream debug(HttpClient httpclient, String verb, String uri, HttpServletRequest request, Header[] headers, InputStream requestEntity) {
    ...
    private HttpResponse forward(HttpClient httpclient, String verb, String uri, HttpServletRequest request, Header[] headers, InputStream requestEntity) {

        requestEntity = debug(httpclient, verb, uri, request, headers, requestEntity);

        org.apache.http.HttpHost httpHost = getHttpHost();
...
//            httpclient.getConnectionManager().shutdown();
    ...
    public Header[] buildZuulRequestHeaders(HttpServletRequest request) {
